...
If the sensitive flows are identified for the app, the app's data would be moved to the target directory.
"""
import json
import os
import re
...
def filter_pcap_helper(ip, data, packet):
    """
    The implementation to filter pcap based on ip and data.
    :param ip:
    :param data:
    :param packet:
    :return:
